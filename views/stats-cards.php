            ...
            <div class="scso-stats-grid">
                <div class="scso-stat-card">
                    ...
                    <div class="scso-stat-label"><?php esc_html_e('High Opportunity', 'rankiva-seo-insights-for-gsc'); ?>
                        <span class="scso-tooltip" data-tip="<?php esc_html_e('Opportunity Score (0–100). Calculated from impressions, ranking position, and CTR gap. Higher score means faster SEO improvement potential.', 'rankiva-seo-insights-for-gsc'); ?>">ⓘ</span>
                    </div>
                </div>
                <div class="scso-stat-card">
                    ...
                    <div class="scso-stat-label"><?php esc_html_e('Posts with Traffic', 'rankiva-seo-insights-for-gsc'); ?>
                        <span class="scso-tooltip" data-tip="<?php esc_html_e('Number of published posts that received impressions from Google Search Console during the last sync period. Posts with zero impressions are excluded.', 'rankiva-seo-insights-for-gsc'); ?>">ⓘ</span>
                    </div>
                </div>
                <div class="scso-stat-card">
